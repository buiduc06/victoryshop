    ...
    <div class="row content">
      <div class="col-sm-2 sidenav">
        ...
        <ul class="nav nav-pills nav-stacked">
          <li><a href="<?php echo getUrl('admin/index')?>"><span class="glyphicon glyphicon-home btn-sm"></span>Sản Phẩm</a></li>
          <li><a href="<?php echo getUrl('admin/category')?>"><span class="glyphicon glyphicon-tasks btn-sm"></span>Danh Mục</a></li>
          <li><a href="<?php echo getUrl('admin/show-member')?>"><span class="glyphicon glyphicon-user btn-sm"></span>Thành Viên</a></li>
          <li><a href="<?php echo getUrl('admin/security')?>"><span class="glyphicon glyphicon-wrench btn-sm"></span>Settings</a></li>
          <li><a href="<?php echo getUrl('admin/show-oder')?>"><span class="glyphicon glyphicon-shopping-cart btn-sm"></span>Đơn Đặt Hàng</a></li>
